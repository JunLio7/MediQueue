        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (running) {
                try {
                    ...
                    switch (choice) {
                        case "1" -> {
                            ...
                            while (true) {
                                ...
                                if (name.isEmpty()) System.out.println("Name cannot be blank.");
                                else if (name.matches(".*\\d.*")) System.out.println("Name cannot contain numbers.");
                                else break;
                            }
                            ...
                            while (true) {
                                ...
                                if (condition.isEmpty()) System.out.println("Condition cannot be blank.");
                                else break;
                            }
                        ...
                        case "3" -> { 
                            ...
                            if (updateName.isEmpty()) throw new Exception("Name cannot be blank.");

                            System.out.print("Enter new condition: ");
                            String newCondition = scanner.nextLine().trim();
                            if (newCondition.isEmpty()) throw new Exception("Condition cannot be blank.");
                        ...
                        case "4" -> {
                            ...
                            if (removeName.isEmpty()) throw new Exception("Name cannot be blank.");
                        ...
                        case "5" -> { // Search patient
                            ...
                            if (searchName.isEmpty()) throw new Exception("Name cannot be blank.");

                            Optional<Patient> patientOpt = queueManager.findPatientByName(searchName);
                            if (patientOpt.isPresent()) {
                                System.out.println("Patient found:");
                                patientOpt.get().displayInfo();
                            } else System.out.println(searchName + " not found in the queue.");
                        }
                    ...
                    // You can put any cleanup code here if needed in the future
                }
            }
        }
    }
